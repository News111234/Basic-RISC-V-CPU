...
module alu (
    ...
    input  wire [3:0]  alu_op_i,  // ALU操作码（4位，支持 M 扩展）
    
    // 操作码定义：
    // 0000: ADD/ADDI - 加法
    // 0001: SUB/BEQ/BNE - 减法
    // 0010: SLL/SLLI - 逻辑左移
    // 0011: SLT/SLTI - 有符号小于比较
    // 0100: SLTU/SLTIU - 无符号小于比较
    // 0101: XOR/XORI - 异或
    // 0110: OR/ORI/SRL/SRLI - 或/逻辑右移
    // 0111: AND/ANDI/SRA/SRAI - 与/算术右移
    // 
    // M 扩展乘除法：
    // 1000: MUL - 有符号乘法（低32位）
    // 1001: MULH - 有符号乘法（高32位）
    // 1010: MULHSU - 有符号乘无符号（高32位）
    // 1011: MULHU - 无符号乘法（高32位）
    // 1100: DIV - 有符号除法
    // 1101: DIVU - 无符号除法
    // 1110: REM - 有符号取模
    // 1111: REMU - 无符号取模
